...
import { MetadataPagination, OrderTypes, Tool, useToolsQuery } from "../../../domain/graphql";
                ...
                <tbody>
                  {
                    data?.Tools.map((tool)=> {
                      return (
                        ...
                        <td className="whitespace-nowrap px-6 py-4">{tool.reference}</td>
                        <td className="whitespace-nowrap px-6 py-4">{tool.units?.length || 0}</td>
